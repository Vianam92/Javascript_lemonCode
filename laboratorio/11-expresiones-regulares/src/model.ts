export const inputValue = document.querySelector(".iban");
export const textarea = document.querySelector(".textarea");
export const btnElement = document.querySelector(".button-event");
export const mensFormado = document.querySelector(".format");
export const mensValid = document.querySelector(".isValid");
export const codigoSursal = document.querySelector(".codigo-span");
export const digitoControl = document.querySelector(".digito-span");
export const numeroCuenta = document.querySelector(".cuenta-span");
export const banco = document.querySelector(".banco-span");
